    ...
    : wxDialog(parent, id, title, position, size, style)
{
  ...
  const wxString DolphinText = _("UncBuild - Dolphin");
  const wxString RevisionText = Common::scm_desc_str + " - By Iris Flower, original FPM by Bird";
  ...
  wxHyperlinkCtrl* const Download = new wxHyperlinkCtrl(this, wxID_ANY, "github.com/WoodleyBrew/UncBuild-Ultimate/releases/latest",
                                                        "https://github.com/WoodleyBrew/UncBuild-Ultimate/releases/latest");
